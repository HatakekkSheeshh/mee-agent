...
def _agent_system_prompt(state: ChatState) -> str:
    ...
    return (
        ...
        "- Khi GỌI tool, KHÔNG viết text đi kèm — TUYỆT ĐỐI không khẳng định đã "
        "thực hiện xong ('Đã gửi…', 'Đã tạo…') khi tool CHƯA chạy và CHƯA được "
        "duyệt. Chỉ thông báo kết quả SAU khi nhận được kết quả tool thật.\n"
