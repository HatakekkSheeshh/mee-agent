...
# Env-overridable so each deployment picks its own default without a code change.
# Dev/MaaS deploys keep "whisper" (VNG); the AgentBase deploy sets
# DEFAULT_STT=faster_whisper to use the self-hosted 2080 server by default.
DEFAULT_STT = os.getenv("DEFAULT_STT", "whisper")
