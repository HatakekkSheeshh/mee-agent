...
# ════════════════════════════════════════════════════════════════════
 ...
 POST http://61.28.229.187:9100/v1/audio/transcriptions/stream → 404 Not Found
  Bà chọn faster-whisper/phowhisper (server 2080). App gọi endpoint streaming /v1/audio/transcriptions/stream — mà server 2080 CHƯA implement cái này
